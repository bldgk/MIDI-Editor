...
{
    [DataContract]
    class LineSeventhEighth : Line
    {
        public LineSeventhEighth()
        {
        ...
        public LineSeventhEighth(int staffIndex)
        {
        ...
        public NameLine Line_sName
        {
            ...
            set
            {
                base.NameLine = MIDI_Library.NameLine.BetweenSeventhAndEighth;
            }
        }
        [DataMember]
