...
{
    [DataContract]
    public class LineSeventh : Line
    {
        public LineSeventh()
        {
            this.Y = Staff.Staff_to_up + Staff.Between_staff_rows;
            Line_sName = MIDI_Library.NameLine.Seventh;
            Note_sName = MIDI_Library.NoteName.C;
            Note_sOctave = MIDI_Library.NoteOctave.Third;
            Lines.Add(this);
        }
        public LineSeventh(int staffIndex)
        {
            this.Y = Staff.Staff_to_up + Staff.Between_staff_rows + staffIndex * Staff.Between_staffs;
            Line_sName = MIDI_Library.NameLine.Seventh;
            Note_sName = MIDI_Library.NoteName.C;
            Note_sOctave = MIDI_Library.NoteOctave.Third;
